...
from fedml_api.distributed.lightsecagg.LightSecAggAPI import FedML_init, FedML_LightSecAgg_distributed
...
def add_args(parser):
    ...
    parser.add_argument("--targeted_number_active_clients", type=int, default=4, help="targerted_number_active_clients")

    parser.add_argument("--privacy_guarantee", type=int, default=2, help="privacy_guarantee")

    parser.add_argument("--prime_number", type=int, default=2 ** 31 - 1, help="prime_number")

    parser.add_argument("--precision_parameter", type=int, default=10, help="precision_parameter")
...
if __name__ == "__main__":
    ...
    str_process_name = "LightSecAgg(distributed):" + str(process_id)
    ...
    try:
        if args.client_num_per_round > args.targeted_number_active_clients:
            args.targeted_number_active_clients = args.client_num_per_round

        # start "federated averaging (LightSecAgg)"
        FedML_LightSecAgg_distributed(
            process_id,
            worker_number,
            device,
            comm,
